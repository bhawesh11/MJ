...
public class STC_Misc {
	...
	public  void verifyDisclaimerMessages(Testing test){
        ...
        Assert.assertEquals(test.getOutput("Address_Page_Disclaimer"), test.getTestData("Disclaimer.Address_Page_Disclaimer"));
        ...
        Assert.assertEquals(test.getOutput("Discount_Page_Disclaimer"), test.getTestData("Disclaimer.Discount_Page_Disclaimer"));
        ...
        Assert.assertEquals(test.getOutput("Esignature_Disclaimer"), test.getTestData("Disclaimer.Esignature_Disclaimer"));
        test.getLogger().info("Verification of Esignature Disclaimer is Passed!!!");
        Assert.assertEquals(test.getOutput("Redpoint_County_Disclaimer"), test.getTestData("Disclaimer.Redpoint_County_Disclaimer"));
        test.getLogger().info("Verification of Redpoint County Disclaimer is Passed!!!");
        Assert.assertEquals(test.getOutput("DebitAmount_Disclaimer"), test.getTestData("Disclaimer.DebitAmount_Disclaimer"));
