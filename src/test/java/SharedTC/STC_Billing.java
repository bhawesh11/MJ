...
public class STC_Billing {
	...
	public void fillCurrentCardDetails_Apparent(Testing test) {
		test.setPage(Billing.class);
        Billing billing = (Billing) PageFactory.initElements(test.driver, test.getPage());
        ...
        test.webFunctions().dropdown(test,billing.dropDown_CreditCardExpiryMonth_Apparent, test.getTestData("Billing.ExpiryMonth"));
        test.webFunctions().dropdown(test,billing.dropDown_CreditCardExpiryYear_Apparent, test.getTestData("Billing.ExpiryYear"));
        if(test.getTestData("Billing.EditCurrentInstrumentAddress").equals("Yes")) {
        	editCurrentCardAddress(test);
        }
    }
	
	public void fillCurrentCardDetails_Elephant(Testing test) {
        test.setPage(Billing.class);
        Billing billing = (Billing) PageFactory.initElements(test.driver, test.getPage());
        ...
        test.webFunctions().dropdown(test,billing.dropDown_CreditCardExpiryMonth_Elephant, test.getTestData("Billing.ExpiryMonth"));
        test.webFunctions().dropdown(test,billing.dropDown_CreditCardExpiryYear_Elephant, test.getTestData("Billing.ExpiryYear"));
        if(test.getTestData("Billing.EditCurrentInstrumentAddress").equals("Yes")) {
        	editCurrentCardAddress(test);
        }
  }
	...
	public void fillFutureCardDetails_Elephant(Testing test) {
        test.setPage(Billing.class);
        Billing billing = (Billing) PageFactory.initElements(test.driver, test.getPage());
        test.webFunctions().type(test,billing.textBox_FutureCardHolderFirstName_Elephant, test.getTestData("Billing.FutureCardHolderFirstName"));
        test.webFunctions().type(test,billing.textBox_FutureCardHolderLastName_Elephant, test.getTestData("Billing.FutureCardHolderLastName"));
        test.webFunctions().type(test,billing.textBox_FutureCardNumber_Elephant, test.getTestData("Billing.FutureCardNo"));
        ...
        test.webFunctions().type(test,billing.textBox_FutureCardHolderNickName_Elephant, test.getTestData("Billing.FutureCardNickName"));
	...
	public void fillFutureACHDetails_Elephant(Testing test) {
        test.setPage(Billing.class);
        Billing billing = (Billing) PageFactory.initElements(test.driver, test.getPage());
        test.webFunctions().type(test,billing.textBox_FutureACHFirstName_Elephant, test.getTestData("Billing.FutureACHFirstName"));
        test.webFunctions().type(test,billing.textBox_FutureACHLastName_Elephant, test.getTestData("Billing.FutureACHLastName"));
        test.webFunctions().type(test,billing.textBox_FutureACHRoutingNumber_Elephant, test.getTestData("Billing.ACHRoutingNumber"));
        test.webFunctions().type(test,billing.textBox_FutureAccountNumber_Elephant, test.getTestData("Billing.ACHAccountNumber"));
        test.webFunctions().dropdown(test,billing.dropDown_FutureAccountType_Elephant, test.getTestData("Billing.AccountType"));     
        if(test.getTestData("Billing.EditFutureInstrumentAddress").equals("Yes")) {
        	editFutureInstrumentAddress(test);
        }
     }	
	...
	public void fillFutureCardDetails_Apparent(Testing test) {
        test.setPage(Billing.class);
        Billing billing = (Billing) PageFactory.initElements(test.driver, test.getPage());
        test.webFunctions().type(test,billing.textBox_FutureCardHolderFirstName_Apparent, test.getTestData("Billing.FutureCardHolderFirstName"));
        test.webFunctions().type(test,billing.textBox_FutureCardHolderLastName_Apparent, test.getTestData("Billing.FutureCardHolderLastName"));
        test.webFunctions().type(test,billing.textBox_FutureCardNumber_Apparent, test.getTestData("Billing.FutureCardNo"));
        ...
        test.webFunctions().type(test,billing.textBox_FutureCardHolderNickName_Apparent, test.getTestData("Billing.FutureCardNickName"));
        if(test.getTestData("Billing.EditFutureInstrumentAddress").equals("Yes")) {
        	editFutureInstrumentAddress(test);
        }
	}
	...
	public void fillFutureACHDetails_Apparent(Testing test) {
        test.setPage(Billing.class);
        Billing billing = (Billing) PageFactory.initElements(test.driver, test.getPage());
        test.webFunctions().type(test,billing.textBox_FutureACHFirstName_Apparent, test.getTestData("Billing.FutureACHFirstName"));
        test.webFunctions().type(test,billing.textBox_FutureACHLastName_Apparent, test.getTestData("Billing.FutureACHLastName"));
        test.webFunctions().type(test,billing.textBox_FutureACHRoutingNumber_Apparent, test.getTestData("Billing.ACHRoutingNumber"));
        test.webFunctions().type(test,billing.textBox_FutureAccountNumber_Apparent, test.getTestData("Billing.ACHAccountNumber"));
        test.webFunctions().dropdown(test,billing.dropDown_FutureAccountType_Apparent, test.getTestData("Billing.AccountType"));     
        if(test.getTestData("Billing.EditFutureInstrumentAddress").equals("Yes")) {
        	editFutureInstrumentAddress(test);
        }
     }	
	...
	public void selectFuturePaymentOptionGAOHApparent(Testing test) {
        test.setPage(Billing.class);
        Billing billing = (Billing) PageFactory.initElements(test.driver, test.getPage());             
	...
	//Method to update address for current card. Same for both Elephant and Apparent
	public void editCurrentCardAddress(Testing test) {
        test.setPage(Billing.class);
        Billing billing = (Billing) PageFactory.initElements(test.driver, test.getPage()); 
        test.webFunctions().click(test,billing.btn_EditCardAddress); 
        test.webFunctions().type(test,billing.textBox_CurrentCardStreet, test.getTestData("Billing.CurrentCardStreetAddress"));
        ...
        test.webFunctions().dropdown(test,billing.dropdown_CurrentCardState, test.getTestData("Billing.CurrentCardState"));
        test.webFunctions().type(test,billing.textBox_CurrentCardZip, test.getTestData("Billing.CurrentCardZip"));        
    }
	
	//Method to update address for Future Instrument. Same for both Elephant and Apparent
	public void editFutureInstrumentAddress(Testing test) {
        test.setPage(Billing.class);
        Billing billing = (Billing) PageFactory.initElements(test.driver, test.getPage()); 
        test.webFunctions().click(test,billing.btn_EditFutureInstrumentAddress); 
        test.webFunctions().type(test,billing.textBox_FutureInstrumentStreet, test.getTestData("Billing.FutureInstrumentStreetAddress"));
        test.webFunctions().type(test,billing.textBox_FutureInstrumentApt, test.getTestData("Billing.FutureInstrumentCardApt"));
        test.webFunctions().type(test,billing.textBox_FutureInstrumentCity, test.getTestData("Billing.FutureInstrumentCity"));
        ...
        test.webFunctions().type(test,billing.textBox_FutureInstrumentZip, test.getTestData("Billing.FutureInstrumentZip"));        
    }
